...
public class SubscriptionAPI {
    ...
    public static ResponseSafe2PayRecurrence Simulation(Subscription payload) {
     ...
     public static ResponseSafe2PayRecurrence DisableSubscription(int Id) {
         ...
         ResponseSafe2PayRecurrence response = Client.HttpClient("PATCH",  MessageFormat.format("V1/Subscriptions/{0}/Disable", (Integer.toString(Id))), null, false,"services");
        return response;
    }

     public static ResponseSafe2PayRecurrence UpdateToken(String token, int Id) {

         ResponseSafe2PayRecurrence response = Client.HttpClient("PATCH", MessageFormat.format("V1/Subscriptions/{0}/UpdateTokenCard", (Integer.toString(Id))),token, false, "services");
        return response;
    }
